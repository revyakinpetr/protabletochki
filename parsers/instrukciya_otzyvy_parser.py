...
WEBSITE_URL = 'http://instrukciya-otzyvy.ru/'
WEBSITE_NAME = 'instrukciya-otzyvy'


def get_query_url(query):
    return f'{WEBSITE_URL}/search.html?searchid=1892019&text={query}&web=0'
